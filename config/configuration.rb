...
SimpleConfig.for :application do
  ...
  load Rails.root.join('config/settings/application.rb'), if_exists?: true
  ...
  load Rails.root.join("config/settings/#{Rails.env}.rb"), if_exists?: true
  ...
  load Rails.root.join('config/settings/local.rb'), if_exists?: true
end
