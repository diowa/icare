...
describe ItinerarySearchService do
  describe 'search' do
    ...
    it "rescues on errors" do
      itineraries = ItinerarySearchService.new({}, male_user).itineraries
    ...
    it "returns itineraries nearby" do
      ...
      itineraries = ItinerarySearchService.new(search_params, male_user).itineraries
    ...
    it "hides pink itineraries to male users" do
      ...
      itineraries = ItinerarySearchService.new(search_params, male_user).itineraries
      expect(itineraries).to be_empty
      itineraries = ItinerarySearchService.new(search_params, female_user).itineraries
    ...
    it "manages round trip filter" do
      ...
      itineraries = ItinerarySearchService.new(search_params.merge(filter_round_trip: '1'), male_user).itineraries
    ...
    it "manages pink filter for female users" do
      ...
      itineraries = ItinerarySearchService.new(search_params.merge(filter_pink: '1'), female_user).itineraries
      expect(itineraries.count).to be 2
    end
    ...
    it "overrides the pink filter for male users" do
      FactoryGirl.create :itinerary, start_location: [0, 0], end_location: [1, 1]
      2.times { FactoryGirl.create :itinerary, start_location: [0, 0], end_location: [1, 1], pink: true, user: female_user }
      itineraries = ItinerarySearchService.new(search_params.merge(filter_pink: '1'), male_user).itineraries
      expect(itineraries.count).to be 1
    end
    ...
    it "manages verified filter" do
      ...
      itineraries = ItinerarySearchService.new(search_params.merge(filter_verified: '1'), female_user).itineraries
      expect(itineraries.count).to be 2
    end
    ...
    it "manages smoking filter" do
      ...
      smoking_itineraries = ItinerarySearchService.new(search_params.merge(filter_smoking_allowed: 'true'), male_user).itineraries
      no_smoking_itineraries = ItinerarySearchService.new(search_params.merge(filter_smoking_allowed: 'false'), male_user).itineraries
    ...
    it "manages pets filter" do
      ...
      pets_itineraries = ItinerarySearchService.new(search_params.merge(filter_pets_allowed: 'true'), male_user).itineraries
      no_pets_itineraries = ItinerarySearchService.new(search_params.merge(filter_pets_allowed: 'false'), male_user).itineraries
    ...
    it "manages gender filter" do
      ...
      male_itineraries = ItinerarySearchService.new(search_params.merge(filter_driver_gender: 'male'), male_user).itineraries
      female_itineraries = ItinerarySearchService.new(search_params.merge(filter_driver_gender: 'female'), male_user).itineraries
      all_itineraries = ItinerarySearchService.new(search_params.merge(filter_driver_gender: 'samurai'), male_user).itineraries
