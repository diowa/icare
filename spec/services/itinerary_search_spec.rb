  ...
  context '.itineraries' do
    ...
    it 'discards expired itineraries' do
      travel_to '2013-01-01' do
        ...
        valid_itinerary_1 = create :itinerary, start_location: [0, 0], end_location: [1, 1], leave_date: '2013-01-05'
        valid_itinerary_2 = create :itinerary, start_location: [1, 1], end_location: [0, 0], leave_date: '2013-01-02', return_date: '2013-01-05', round_trip: true
